...
const AccessDenied = () => {
  return (
    <div className=' bg-[#233142] flex flex-col relative items-center justify-center'>
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enableBackground="new 0 0 1000 1000" xmlSpace="preserve"
     className="whistle">
      ...
      <h1 className='text-white text-[100px]'>403</h1>
        <h2 className='mb-[100px] mt-4 text-white text-[20px]'>Did not we say you have to be an admin to get here ?</h2>
        <div>.</div>
    </div>
  )
}
